...
const photos = [
  ...
  { id: 1, src: ballet, alt: 'ballet', title: 'Ballet' },
  { id: 3, src: equipe, alt: 'equipe', title: 'Equipe' },
  { id: 4, src: formado, alt: 'formado', title: 'Formado' },
  { id: 5, src: herois_evento, alt: 'herois no evento', title: 'Herois no Evento' },
  { id: 6, src: luta_evento, alt: 'luta no evento', title: 'Luta no Evento' },
  { id: 7, src: manicure, alt: 'manicure', title: 'Manicure' },
  { id: 8, src: touro_evento, alt: 'touro mecanico no evento', title: 'Touro Mecânico no Evento' },
];
